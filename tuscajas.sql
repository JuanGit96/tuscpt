...
--
-- Estructura de tabla para la tabla `agentcies`
--
...
CREATE TABLE `agents` (
  ...
  `agencie_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Estructura de tabla para la tabla `order_extra`
--
...
ALTER TABLE `agents`
  ...
  ADD KEY `agents_agencie_id_index` (`agencie_id`);

--
-- Indices de la tabla `order_extra`
--
ALTER TABLE `order_extra`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_extra_order_id_index` (`order_id`),
  ADD KEY `order_extra_extra_id_index` (`extra_id`);
...
ALTER TABLE `agents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT de la tabla `order_extra`
--
ALTER TABLE `order_extra`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
...
--
ALTER TABLE `agents`
  ADD CONSTRAINT `agents_agencie_id_foreign` FOREIGN KEY (`agencie_id`) REFERENCES `agencies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `agents_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
--
-- Filtros para la tabla `order_extra`
--
ALTER TABLE `order_extra`
  ADD CONSTRAINT `order_extra_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `order_extra_extra_id_foreign` FOREIGN KEY (`extra_id`) REFERENCES `extras` (`id`) ON DELETE CASCADE;

--
-- Añadir la columna codepromo a la tabla orders
--
ALTER TABLE  `orders` 
  ADD  `codepromo` VARCHAR( 10 ) NOT NULL AFTER  `code`;
--
-- Añadir la columna value a la tabla orders
--
ALTER TABLE  `orders` 
  ADD  `value` decimal(8,2) NOT NULL AFTER  `kit_id`;

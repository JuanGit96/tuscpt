...
<table class="wrapper" style="background: #ffffff;" border="0" width="600" cellspacing="0" cellpadding="0"
    ...
    <tr>
        <td>
            <table style="background-repeat: no-repeat; background-color: #7b057e; background-position: left top; background-size: 100% 100%;"
                                                ...
                                                <table border="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="editable"
                                                            ...
                                                            contenteditable="false" data-selector="td.editable">&iexcl;NUEVA
                                                            COMPRA!
                                                        </td>
                                                        <td width="30">&nbsp;</td>
                                                        <td class="pink-heart" width="34">&nbsp;</td>
                                ...
                                <td style="height: 95px;">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr style="height: 138px;">
                                            <td class="editable"
                                                style="padding-left: 10px; background-color: #7b057e; color: #fff8e9; font-size: 14px; text-align: left; font-weight: bold; line-height: 1.7; outline: currentcolor none medium; outline-offset: 2px; height: 138px; width: 49.5819%;"
                                                contenteditable="false" data-selector="td.editable">
                                            ...
                                            <td class="editable"
                                                style="border-left: 1px solid; padding-left: 10px; background-color: #7b057e; color: #fff8e9; font-size: 14px; text-align: left; font-weight: bold; line-height: 1.7; outline: currentcolor none medium; outline-offset: 2px; height: 138px; width: 49.7492%;"
                                                ...
                                                <p>
                                                    ...
                                                    <label><strong>VALOR DE ENVIO: </strong></label>{{'$'.number_format($order->shipping)}}<br>
                                                        @if($order->shipping == 0)
                                                            ...
                                                            @else
                                                                <label><strong>ENVIO: </strong></label>EL CLIENTE LLEGA POR LAS CAJAS<br>
                                                            @endif

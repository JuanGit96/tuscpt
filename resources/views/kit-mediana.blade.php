...
<title>Kit para oficina mediana - Tus Cajas Para Trasteos</title>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-title">
          <h1 class="text-center">Kit de oficina mediana</h1>
          <div class="propuesta-v">
            <hr>
            <p><span>Tu negocio crece</span> al pasar de los tiempos, una mudanza es necesaria, tenemos el kit perfecto para <span>tu progreso y crecimiento</span>. ¡Adquiérelo ya!</p>
          </div>
        </div>
                  ...
                  <div class="panel panel-default">
                      ...
                      <div id="panel-element-2-2" class="panel-collapse collapse in">
                          <div class="panel-body">
                              <div>
                                  <ul>
                                      <li><strong>40</strong> Cajas</li>
                                      <li><strong>24</strong> Cajas grandes</li>
                                  ...
                                  <div class="form-price">
                                    por solo: <strong>$540.260</strong>
                                  </div>
                                  <br>
                              </div>
                          </div>

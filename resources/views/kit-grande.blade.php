...
<title>Kit para oficina grande - Tus Cajas Para Trasteos</title>
...
@section('content')
<div class="wallpaper">
	<div class="container-fluid form-general form-general-grande">
		<div class="row">
			<div class="col-md-12">
				<div class="form-title">
					<h1 class="text-center">Kit de oficina grande</h1>
					<div class="propuesta-v">
						<hr>
						<p>A <span>pasos de gigante</span> vas con tu trabajo, tus cajas para trasteos quiere ayudarte a <span></span> y te trae el kit que necesitas, ¡Adquiérelo ya!</p>
					</div>
				</div>
							...
							<div class="panel-body panel-body1">
								<div class="panel-group" id="panel-int2">
									...
									<div class="panel panel-default">
											...
											<div id="panel-element-2-3" class="panel-collapse collapse in">
													<div class="panel-body">
															<div>
																	<ul>
																			<li><strong>78</strong> Cajas</li>
																			<li><strong>46</strong> Cajas grandes</li>
																	...
																	<div class="form-price">
																		por solo: <strong>$1'195.550</strong>
																	</div>
																	<br>
																</div>
													</div>
...
<script src="{{asset('js/hora.js')}}"></script>
	...
	$(document).ready(function() {
		...
		$('.title-2-3 .responsive-metros').slideDown('fast');

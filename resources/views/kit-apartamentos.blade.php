...
<title>Kit para apartamento - Tus Cajas Para Trasteos</title>
...
@section('content')
        ...
        <div class="panel-body panel-carrito">
            <div>
                ...
                <div class="form-price pull-right">
                    por solo: <strong>$206.000</strong>
    ...
    <input type="hidden" id="valueThisKit" value="206000">
    <input type="hidden" id="actualExtraModal" class="actualExtraModal" value="0">

    {{----}}
<div class="wallpaper">
  <div class="container-fluid form-general form-general-apart">
    <div class="row">
      <div class="col-md-12">
        <div class="form-title">
          <h1 class="text-center">Kit para apartamento</h1>
          <div class="propuesta-v">
            <hr>
            <p>Una <span>gran decisión</span>, un <span>cambio importante</span> y muchas cosas buenas por venir, tus cajas para trasteos te ofrece el <span>kit para esta nueva etapa</span>.
          </div>
        </div>
            ...
            <div class="row" id="panel-responsive">
              <div class="panel-body panel-body1">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="panel-element-1-2" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <div>
                                ...
                                <div class="form-price">
                                  por solo: <strong>$206.000</strong>
                                    <div class="hasMoreProducts ocultar"><br>
                                        + <strong class="actualExtra">0</strong>
                                    </div>
                                </div>
                                <br>
                            </div>
          ...
          <div class="col-xs-12 col-sm-8 col-lg-9">
              <form role="form" method="POST" action="{{ action('OrderController@store') }}">
                ...
                {{-- IMÁGENES SELECCIONABLES --}}
                  @include('partials.moreProducts',['alertDinamicColor' => 'alert-dinamic-apartamento'])
                {{--<div class="col-xs-12 ">--}}
                  {{--<div class="col-xs-12 col-sm-6 col-lg-3 checkbox-img" >--}}
                    {{--<!-- <input type="checkbox" name=""> -->--}}
                    {{--<div class="box-general" id="img1">--}}
                      {{--<img src="{{asset('img/biblioteca.jpg')}}" alt="biblioteca apartamento" class="img img img-responsive" width="100%">--}}
                  ...
                  {{--<div class="col-xs-12 col-sm-6 col-lg-3 checkbox-img">--}}
                    {{--<div class="box-general" id="img2">--}}
                      {{--<img src="{{asset('img/decoracion.jpg')}}" alt="decoración apartamento" class="img img img-responsive" width="100%">--}}
                      {{--<div class="gamma-description">--}}
                  ...
                  {{--<div class="col-xs-12 col-sm-6 col-lg-3 checkbox-img">--}}
                    {{--<div class="box-general" id="img3">--}}
                      {{--<img src="{{asset('img/cocina.jpg')}}" alt="cocina apartamento" class="img img img-responsive" width="100%">--}}
                      {{--<div class="gamma-description">--}}
                  ...
                  {{--<div class="col-xs-12 col-sm-6 col-lg-3 checkbox-img">--}}
                    {{--<div class="box-general" id="img4">--}}
                      {{--<img src="{{asset('img/arte.jpg')}}" alt="arte apartamento" class="img img img-responsive" width="100%">--}}
                      {{--<div class="gamma-description">--}}
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.title-1-2 .responsive-metros').slideDown('fast');
